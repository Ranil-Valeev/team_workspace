...
namespace Сourse_management.model
{
    ...
    public partial class CoursesEntities : DbContext
    {
        ...
        private static CoursesEntities _context;
        public static CoursesEntities GetContext()
        {
            if (_context == null)
            {
                _context = new CoursesEntities();
            }
            return _context;
        }
        ...
        public DbSet<Courses_Status> Courses_Status { get; set; }
        ...
        public DbSet<Student_Lessons> Student_Lessons { get; set; }
